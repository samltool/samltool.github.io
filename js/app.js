...
function formatXml(xml) {
  ...
  window.xmlEditor = CodeMirror(document.getElementsByClassName('xml-input')[0], {
    ...
    lineNumbers: true,
    // lineWrapping: true,
    extraKeys: { 'Tab': tabHack, "Ctrl-Q": function(cm){ foldFunc(cm, cm.getCursor().line); }},
    foldGutter: true,
