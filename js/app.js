...
function formatXml(xml) {
  ...
  function parseSaml(samlDecoded) {
    ...
    if (samlObj.Assertion.Conditions) {
      ...
      } else if (samlObj._Version === '1.1') {
        if (samlObj.Assertion.Conditions.AudienceRestrictionCondition) {
  ...
  tokenEditor.on('change keypress paste textInput input', function() {
    var samlDecoded = window.decode($(this).val()).result;
